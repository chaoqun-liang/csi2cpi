...
// Netlist written on Wed Nov 23 18:14:32 2022
...
//
// Verilog Description of module myB2P
// module wrapper written out since it is a black-box. 
//

//

module myB2P (sp_en_i, lp_av_en_i, reset_pixel_n_i, clk_pixel_i, fv_o, 
            lv_o, pd_o, p_odd_o, axis_sclk_i, axis_sresetn_i, axis_svalid_i, 
            axis_sdata_i, axis_sready_o, pixcnt_c_o, pix_out_cntr_o, 
            wc_pix_sync_o);
    input sp_en_i;
    input lp_av_en_i;
